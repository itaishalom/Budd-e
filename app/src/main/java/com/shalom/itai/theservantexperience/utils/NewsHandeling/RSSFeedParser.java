...
public class RSSFeedParser {
     ...
     * @return List of {@link com.shalom.itai.theservantexperience.utils.NewsHandeling.RSSFeedParser.Entry} objects.
 ...
 /*
   ...
   */
    ...
    public static class Entry {
        ...
        Entry(String id, String title, String link, String published) {
            this.id = id;
            this.title = title;
            this.link = link;
