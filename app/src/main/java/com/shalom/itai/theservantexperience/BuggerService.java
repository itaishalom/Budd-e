...
public static BuggerService getInstance(){
    ...
    {
        timerLock = new Timer();
        timerLock.scheduleAtFixedRate(new LockerTimer(this), 0, 500);
    }
    ...
    public  void bug()
    {
        ...
        timerBugger.scheduleAtFixedRate(new TimerTaskForUser(this), 0, 5000);
    }
...
// mId allows you to update the notification later on.
    ...
    private void createFacts(){
        ...
        allFacts = facts.split(" ++ ++");
        allInsults = new ArrayList<>();
        allJokes = new ArrayList<>();
        allInsults.add("Yo momma is so fat, I took a picture of her last Christmas and it's still printing.");
        allInsults.add("Yo momma is so fat when she got on the scale it said, \"I need your weight not your phone number.\"");
        allInsults.add("Yo momma's so fat and old when God said, \"Let there be light,\" he asked your mother to move out of the way.");
        allInsults.add("Yo momma is so fat that Dora can't even explore her!");
        allInsults.add("Yo momma is so fat her bellybutton gets home 15 minutes before she does.");
        ...
        allJokes.add("What happens to a frog's car when it breaks down?\n" +
                "It gets toad away");
        allJokes.add("Q: Is Google male or female? \nA: Female, because it doesn't let you finish a sentence before making a suggestion.");
        allJokes.add("Q: Why was six scared of seven? \n" + "A: Because seven \"ate\" nine.");
    }
